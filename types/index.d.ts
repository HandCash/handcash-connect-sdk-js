...
declare class HttpRequestFactory {
    ...
    static _getRequestSignature(method: string, endpoint: string, serializedBody: string,
                                timestamp: string, privateKey: any): string;

    static _getRequestSignaturePayload(method: string, endpoint: string, serializedBody:
